---
title: "Collaborative Operations for Sustainable Skies: what it means for ATM in 2026"
order: 2
noTitleBreak: true
summary: Enhancing network efficiency and reducing aviation's environmental footprint through cross-border collaboration — free route airspace, ATFM, EUROCONTROL Network Manager operations, and the data-sharing frameworks that connect ANSPs, airports, and airlines.
---
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What does the EUROCONTROL Network Manager do?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The EUROCONTROL Network Manager provides central coordination for the European ATM network, managing airspace capacity and demand across 37 participating ANSPs. Its principal functions include the Central Flow Management Unit, which issues ATFM regulations restricting departure times when demand exceeds sector capacity, and the Network Operations Centre. The Network Manager manages the flow of traffic to prevent cascade delays, without directly controlling aircraft — that remains the responsibility of national ANSPs."
      }
    },
    {
      "@type": "Question",
      "name": "What is free route airspace and how much fuel does it save?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Free route airspace allows airspace users to plan direct, optimised flight trajectories between defined entry and exit points rather than following a fixed historical route network. Where implemented, it eliminates detours and allows aircraft to fly closer to the great-circle track. EUROCONTROL assessments show savings of 30–50 kg of fuel per flight on average on constrained routes. The 2026 sessions assess which airspace volumes remain constrained — primarily due to military activity and political coordination gaps."
      }
    },
    {
      "@type": "Question",
      "name": "What is Collaborative Decision Making in aviation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Collaborative Decision Making is the operational process by which ANSPs, airports, and airlines share real-time information to make joint decisions that improve predictability and reduce waste. Airport CDM integrates ground handling milestones, departure clearance times, and ATFM slot management so aircraft push back only when their slot is imminent. Network CDM extends this to pre-tactical flight planning. The result is less fuel burnt on the apron, fewer missed slots, and better departure punctuality."
      }
    },
    {
      "@type": "Question",
      "name": "How does ATM efficiency reduce aviation's CO₂ emissions?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ATM efficiency reduces CO₂ through trajectory optimisation (flying direct routes rather than historical airways), vertical profile optimisation (continuous climb and descent rather than level-off segments), and reduced holding (absorbing delay on the ground rather than in the air). EUROCONTROL's analysis shows the gap between actual and optimal trajectories in European airspace represents several per cent of total aviation emissions. At 2026 traffic volumes, even a one-per-cent improvement in network trajectory efficiency produces a multi-megatonne annual CO₂ reduction."
      }
    },
    {
      "@type": "Question",
...
ASW 2025 addressed post-pandemic capacity recovery and the first operational year under the revised SES performance framework. [Read the ASW 2025 retrospective](/asw-2025/)

---

**For organisations exhibiting at ASW 2026:** Your ATM efficiency and sustainability content can be structured like this. Maxifi Digital turns conference sessions into AI-citable authority pages in four weeks. [See the Conference Sprint →](https://maxifidigital.com/services/conference-sprint/)
