...
The training cycle from selected candidate to unrestricted en-route ATCO is typically three to five years. Decisions made in 2026 about pipeline volume, training capacity, and selection methodology determine the workforce that will be available in 2029–31. By that point much of the current generation of ATCOs in several major ANSPs will have retired.

> CANSO and EUROCONTROL workforce analysis indicates that **European ANSPs need to recruit and train approximately 5,000–7,000 new air traffic controllers between 2024 and 2030** to maintain operational capacity through the demographic transition [verify].
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Why are air traffic controllers in short supply in 2026?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Air traffic controllers are in short supply in 2026 because of a structural mismatch between the demographic profile of the existing workforce, the pace of the recruitment pipeline, and the post-pandemic recovery in traffic demand. Many ANSPs employ controllers recruited in the 1980s and 1990s; those cohorts are reaching retirement age in significant numbers. The training pipeline was reduced during the pandemic and the rebuild has been slower than the recovery in traffic. Several major European ANSPs are operating below their authorised controller establishment."
      }
    },
    {
      "@type": "Question",
      "name": "How long does it take to train an air traffic controller?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The training pipeline varies by ANSP and intended operational role, but in Europe the typical timeline from selection to unrestricted en-route ATCO rating is three to five years. The pipeline comprises Initial Training (12–18 months for en-route ratings), Unit Training (12–24 months on-site, including extensive simulator work and supervised live operations), and Continuation Training over the controller's career. Initial Training failure rates have historically been a major driver of pipeline attrition."
      }
    },
    {
      "@type": "Question",
      "name": "How is simulation changing controller training?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Simulation has become the central technology of controller training, with high-fidelity radar simulation enabling trainees to develop operational skills at greater intensity and lower risk than is possible in live traffic. The 2026 generation of training simulators integrates AI-driven pseudo-pilots, scenario libraries that exercise specific operational conditions, and recorded performance data supporting objective assessment. Several ANSPs have introduced simulation-based selection. Simulation does not replace live traffic experience but materially changes the structure of the training pipeline."
      }
    },
    {
      "@type": "Question",
      "name": "What is the CANSO Tomorrow's Voices programme?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "CANSO Tomorrow's Voices is the global ATM industry's initiative to bring early-career and emerging professional voices into industry governance and policy debate. The programme provides structured channels through which younger ANSP staff, technology suppliers, regulators, and academic researchers participate in CANSO working groups, contribute to position papers, and present at industry events including Airspace World. The programme addresses talent retention and governance modernisation simultaneously and has expanded through 2024–25."
      }
    },
    {
      "@type": "Question",
      "name": "How is the controller role changing in an AI-augmented operations room?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The controller role is changing along several dimensions as AI-assisted decision support tools enter operational service. The information environment is becoming richer with predictive conflict alerts, optimised arrival sequences, and complexity forecasts layered on conventional displays. The decision rhythm is shifting: routine sequencing decisions are increasingly informed by tool recommendations, freeing controller attention for complex situations. The competency framework now addresses trust calibration, automation monitoring, and the ability to operate when an AI tool is unavailable or unreliable."
      }
    }
  ]
}
...
ASW 2026 workforce sessions address recruitment, training reform, and the evolving controller role.
