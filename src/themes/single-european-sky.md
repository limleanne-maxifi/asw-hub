...
SES2+ moved from political agreement to legal text during 2024 and entered force in 2025. The first reference period under the new performance scheme begins in 2027, which means 2026 is the year ANSPs must finalise their operational plans, capital programmes, and cross-border arrangements. The space for further delay has closed.

> The European Commission has estimated that fragmented European airspace management generates **€5 billion in annual avoidable costs** to airspace users, with an associated **8.6%–11.2% efficiency penalty** versus a fully integrated network [verify].
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the Single European Sky and what does SES2+ change?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The Single European Sky is the EU regulatory framework, originating in 2004, intended to unify the management of European airspace into a performance-driven system that crosses national boundaries. SES2+ is the 2024 revision agreed in response to the post-pandemic capacity crises. The principal changes are sharper performance targets across capacity, environment, and cost-efficiency; strengthened powers for the EUROCONTROL Network Manager; revised governance for cross-border service provision; and a tightened relationship between SES performance assessment and EU funding eligibility."
      }
    },
    {
      "@type": "Question",
      "name": "How does the SES performance scheme work in practice?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The SES performance scheme requires Member States to set binding targets across safety, capacity, environment, and cost-efficiency for each multi-year reference period. Targets are reviewed by the European Commission and the Performance Review Body. ANSPs are assessed against agreed targets, with divergences triggering financial consequences through the en-route charging mechanism. Reference Period 4 (RP4) under SES2+ introduces stricter capacity targets in response to the 2022–24 European summer disruption."
      }
    },
    {
      "@type": "Question",
      "name": "What happened to Functional Airspace Blocks under SES2+?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Functional Airspace Blocks were the SES2 concept under which adjacent ANSPs were expected to integrate airspace management across national borders. In practice, FABs delivered limited operational integration. SES2+ has moved beyond the FAB concept as the principal organising framework, instead emphasising specific cross-border service provision arrangements, joint procurement, and shared technical infrastructure. Existing FAB structures are not abolished but are no longer central."
      }
    },
    {
      "@type": "Question",
      "name": "What is the role of the EUROCONTROL Network Manager?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The EUROCONTROL Network Manager is the centralised function responsible for managing European en-route traffic flow, allocating airspace capacity, coordinating cross-border operations, and providing operational data services. The Network Manager is not an ANSP and does not provide ATC services itself, but sets the daily and tactical traffic flow regulations that determine where ATFM delays are applied. Under SES2+ the Network Manager's mandate has been strengthened in relation to capacity recovery during disruption."
      }
    },
    {
      "@type": "Question",
      "name": "Why has Single European Sky implementation taken so long?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "European airspace management remains a sovereign competence of Member States, with national ANSPs typically employing significant unionised workforces and operating under national charging regimes that fund both ATM infrastructure and ancillary state functions. Each major SES legislative step has therefore required Member State agreement on changes that affect employment, national revenue, and civil–military governance. The political conditions for sharper integration only emerged after the 2022–24 capacity crises made the cost of fragmentation visible."
      }
    }
  ]
}
...
ASW 2026 hosts CANSO CEO discussions and policy panels addressing the Single European Sky directly.

- [CANSO CEO Conversation: ATM Modernisation Across Diverse Fiscal Models](/sessions/closing-the-ses-gap/)
